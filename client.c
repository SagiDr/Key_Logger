...
/* Global state for xkbcommon to maintain modifier context across events */
struct xkb_context *xkb_ctx;
struct xkb_keymap *xkb_kmap;
struct xkb_state *xkb_st;
int server_socket_fd = -1; // Socket file descriptor for the TCP connection to the remote server.
